// triangle_test.cpp — Add triangle rendering to working Vulkan setup
#include <SDL2/SDL.h>
...
int main() {
    ...
    printf("Step 8: vkGetSwapchainImagesKHR and create image views\n");
    ...
    printf("Step 9: Create render pass\n");
    ...
    printf("Step 10: Create framebuffers\n");
    ...
    printf("Step 11: Create command pool and buffer\n");
    ...
    printf("Step 13: Create pipeline\n");
    struct Vertex {
        float pos[3];
        float color[3];
    };
    ...
    VkPipeline pipeline;
    res = vkCreateGraphicsPipelines(device, VK_NULL_HANDLE, 1, &pipeline_info, nullptr, &pipeline);
    if (res != VK_SUCCESS) {
    ...
    printf("Step 14: Create vertex buffer\n");
    ...
    printf("Step 15: Record command buffer\n");
    ...
    printf("Step 16: Submit and present\n");
